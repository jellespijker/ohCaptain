...
namespace oCpt {
    ...
    public:
        ...
        virtual void registerCommunicator(iCom::ptr communicator) = 0;
    ...
    protected:
        ...
        std::vector<iCom::ptr> comDevices_;
    ...
    public:
        ...
        virtual void registerCommunicator(iCom::ptr communicator) override;
